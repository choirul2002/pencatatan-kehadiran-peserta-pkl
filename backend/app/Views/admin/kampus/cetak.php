    ...
    <table id="table1" border="1">
        <thead>
            <tr style="font-size: 12px;">
                ...
                <th style="text-align: center;" width="24%">Asal</th>
                <th style="text-align: center;" width="69%">Alamat</th>
            </tr>
        </thead>
        <tbody>
        <?php $no = 1;
        foreach ($database[1] as $data) { ?>
            <tr style="font-size: 12px;">
                ...
                <td><?= ucwords($data['NAMA_ASAL']) ?>.</td>
                <td><?= ucfirst($data['ALAMAT_ASAL']) ?>.</td>
            </tr>
        <?php $no++;
        } ?>
        </tbody>
